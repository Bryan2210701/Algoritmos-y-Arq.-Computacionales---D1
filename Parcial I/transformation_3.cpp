#include <math.h> // Se mencionan las librerías de C++ utilizadas en el desarrollo
#include <iostream>
...
int main()
{
    ...
    for (int i=0; i<4; i++)
    {
        ...
        cout << endl; // Por último, el programa imprime los nuevos 4 vértices contenidos en la matriz transformada.
    }
